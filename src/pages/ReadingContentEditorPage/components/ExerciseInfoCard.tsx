...
import { BackendReadingQuestionType, mapReadingApiTypeToUi } from "../types";
import {
  BackendTopicTag,
  mapTopicTagApiToUi,
  TopicTag,
...
interface ExerciseInfoCardProps {
  ...
  questionTypeTags: BackendReadingQuestionType[];
  onQuestionTypeTagsChange: (tags: BackendReadingQuestionType[]) => void;
      ...
      <div className="space-y-[16px]">
        ...
        <div>
          ...
          <div className="pointer-events-none">
            <ChipInput
              value={questionTypeTags.map(mapReadingApiTypeToUi)}
              onChange={() => {}}
              placeholder="Add tag..."
              maxTags={100}
            />
